...
class CreditTransaction(Base):
    ...
    kind: Mapped[CreditTxnKind] = mapped_column(SAEnum(CreditTxnKind, name="credit_txn_kind"), nullable=False, index=True)
    ...
    refunded: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, index=True)
