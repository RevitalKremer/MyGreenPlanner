...
export default function RailLayoutTab({
  ...
  lineOrientations,    // ['vertical'|'horizontal', ...]
  ...
  const { zoom, setZoom, panOffset, setPanOffset, panActive, containerRef, contentRef, handleWheel, startPan, handleMouseMove, stopPan, resetView, MM_W, MM_H, panToMinimapPoint, getMinimapViewportRect } = useCanvasPanZoom()
