...
export const PRODUCT_DICT = [
  { type: 'angle_profile_40x40',           pn: '', name: 'Angle Profile 40x40 mm (frame)',          extraPct: 0  },
  ...
  { type: 'block_50x24x15',               pn: '', name: 'Block (50x24x15)',                         extraPct: 0  },
  { type: 'bitumen_sheets',               pn: '', name: 'Bitumen Sheets',                           extraPct: 0  },
  { type: 'jumbo_5x16',                   pn: '', name: 'Jumbo 5x16',                               extraPct: 10 },
  ...
  { type: 'hex_head_bolt_m8x20',          pn: '', name: 'Hex Head Bolt M8x20',                      extraPct: 10 },
