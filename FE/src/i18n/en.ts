...
const en = {
  ...
  'step6.confirmElectricalCredits.message': 'Continuing to the string plan will deduct {cost} credits from your balance (you have {available}). This charge is NON-REFUNDABLE. Continue?',
