...
const en = {
  ...
  'step3.param.edgeSpacingMm':       'Edge Base / Anchor Spacing (mm)',
  'step3.param.extDiagMinHeightCm':  'External Diagonal Min Leg Height (cm)',
  ...
  'bom.reset':             '↺ Start over',
  'bom.resetConfirm':      'Reset the BOM to defaults? This clears all manual edits, added rows, and notes, and regenerates the BOM.',
  'bom.saving':            'Saving…',
  'bom.saved':             '✓ Saved',
  ...
  'bom.altLabel':          'Alt:',
  'bom.notePlaceholder':   'Add note…',
  'bom.addNote':           'Add note',
  'bom.editNote':          'Edit note',
  ...
  'step3.editMode.enterAnchors': 'Edit bases / anchors',
  ...
  'step3.editMode.hintAnchors':  'Drag bases / anchors on the bar to move; click to add or ✕ to remove. Drag base endpoints to extend.',
  'step3.edit.extendTitle':      'Extend',
  'step3.edit.close':            'Deselect',
  'step3.edit.extendFront':      'End 1 (mm)',
  'step3.edit.extendBack':       'End 2 (mm)',
  'step3.edit.applyTo':          'Apply extension to',
  'step3.edit.applyRow':         'Whole row',
  'step3.edit.applyArea':        'Whole area',
