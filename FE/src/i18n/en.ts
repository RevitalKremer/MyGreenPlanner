...
const en = {
  ...
  'step6.settings.tempMin':      'Min design temp (°C)',
  'step6.settings.tempMax':      'Max cell temp (°C)',
  'step6.settings.tempHint':     'Cold temp drives max string voltage; hot cell temp drives min string voltage.',
  ...
  'admin.sadot.col.specs':         'Electrical specs',
