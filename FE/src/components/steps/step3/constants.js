...
export const PARAM_SCHEMA = [
  ...
  { key: 'spacingMm',           label: 'Base Spacing (mm)',       section: 'bases',  scope: 'trapezoid', type: 'number',   step: 50,  min: 100, max: 5000, default: 2000, highlightGroup: 'base-spacing' },
  { key: 'baseOverhangCm',      label: 'Base Overhang (cm)',      section: 'bases',  scope: 'trapezoid', type: 'number',   step: 0.5, min: 0,   max: 50,   default: 5,    highlightGroup: 'base-overhang'},
  // ── detail · area ─────────────────────────────────────────────────────────
